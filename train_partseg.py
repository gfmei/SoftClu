...
from models.encoder import DGCNNPartSeg
...
def vis(args):
    net = DGCNNPartSeg(args.emb_dims, args.num_clus, args.dropout, None, pretrain=True).cuda()
...
if __name__ == "__main__":
    ...
    if args.cuda:
        ...
        io.cprint('Using CPU')
    train_dataset = ShapeNetPart(args.root, partition='trainval', num_points=args.num_points,
                                 class_choice=args.class_choice)
